...
class ghjghj(MacroSpec):
    name: str = "ghjghj"
    projectName: str = "external_sql_simple_project"
    category: str = "Transform"


    @dataclass(frozen=True)
    class ghjghjProperties(MacroProperties):
    ...
    def apply(self, props: ghjghjProperties) -> str:
    ...
    def loadProperties(self, properties: MacroProperties) -> PropertiesType:
        ...
        return ghjghj.ghjghjProperties(
